            ...
            foreach ($array as $key => $value) {
                foreach ($value as $row) {
                    ...
                    $cadena = $row['cod_mod'].$row['anexo'].$row['codlocal'].$row['cen_edu'].$row['niv_mod'].$row['d_niv_mod'].$row['d_forma'].
                        ...
                        $row['localidad'].$row['codcp_inei'].$row['codccpp'].$row['cen_pob'].$row['area_censo'].$row['dareacenso'].$row['codgeo'].
                        $row['d_dpto'].$row['d_prov'].$row['d_dist'].$row['d_region'].$row['codooii'].$row['d_dreugel'].$row['tipoprog'].$row['d_tipoprog'].
                        $row['cod_tur'].$row['d_cod_tur'].$row['estado'].$row['d_estado'].$row['d_fte_dato'].$row['talum_hom'].$row['talum_muj'].
                        $row['talumno'].$row['tdocente'].$row['tseccion'].$row['fechareg'].$row['fecha_act'];
                }
            }
