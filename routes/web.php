...
Route::post('/INDICADOR/PNSR2/{provincia}/{distrito}/{indicador_id}/{estado_conexion_id}/{fecha}', [IndicadorController::class, 'indicadorviv2pnsrcab'])->name('ind.ajax.pnsr2');
