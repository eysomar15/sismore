...
@section('css')
    ...
    {{-- sirve para las selecciones multiples --}}
    <link href="{{ asset('/') }}assets/libs/select2/select2.min.css" rel="stylesheet" type="text/css" />
    {{-- <link href="{{ asset('/') }}assets/libs/bootstrap-touchspin/jquery.bootstrap-touchspin.min.css" rel="stylesheet" />
    <link href="{{ asset('/') }}assets/libs/switchery/switchery.min.css" rel="stylesheet" />
    ...
    <div class="content">
        ...
        <div class="row">
            <div class="col-xl-6">
                    ...
                    <div class="card-body">
                        ...
                        <form class="form-horizontal">
                            <div class="form-group row mb-0">
                                <label class="col-md-3 col-form-label">Input Tags</label>
                                <div class="col-md-9">
                                    <input type="text" value="admin,dashboard,xyz" data-role="tagsinput"
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Select2 Components</h3>
                    </div>
                    <div class="card-body">
                        <form action="#" class="form-horizontal">
                            <div class="form-group row mb-4">
                                <label class="col-md-3 col-form-label">Select2</label>
                                <div class="col-md-9">
                            ...
                            <div class="form-group row mb-0">
                                <label class="col-md-3 col-form-label">Select2 Multiple</label>
                                <div class="col-md-9">
                                    <select class="form-controlselect2-multiple" data-toggle="select2" multiple="multiple"
                                        data-placeholder="Choose a Country...">
                                        <option value="#">&nbsp;</option>
                                        <option value="United States">United States</option>
                                        <option value="United Kingdom">United Kingdom</option>
            ...
            <div class="col-xl-6">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Switchery</h3>
                    </div>
                    <div class="card-body">

                        <h5 class="font-15 mt-0">Basic</h5>
                        <p class="sub-header">
                            Add an attribute <code>
                                data-plugin="switchery" data-color="@colors"</code> to your input element and it will be
                            converted into switch.
                        </p>
                        ...
                        <h5 class="mt-4 font-15">Sizes & Secondary color</h5>
                        <p class="sub-header">
                            Add an attribute <code>
                                data-size="small",data-size="large"</code> to your input element and it will be converted
                            into switch. Add an attribute <code>
                                data-color="@color" data-secondary-color="@color"</code> to your input element and it will
                            be converted into switch.
                        </p>
