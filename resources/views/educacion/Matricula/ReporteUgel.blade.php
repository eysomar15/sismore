    ...
    <div class="col-md-6">
        <div class="card-header bg-primary py-3 text-white">
            <h5  class="card-title mb-0 text-white"> Total matrícula EBR según UGEL al {{$fecha_Matricula_texto}} </h5>
        </div>
        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header bg-primary py-3 text-white">
                    ...
                    <h5 class="card-title mb-0 text-white">Total matrícula nivel INICIAL por Ciclo, Edad  y Sexo según UGEL al {{$fecha_Matricula_texto}}</h5>
                </div>
        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header bg-primary py-3 text-white">
                    ...
                    <h5 class="card-title mb-0 text-white">Total matrícula nivel PRIMARIA por grado y sexo según UGEL al {{$fecha_Matricula_texto}}</h5>
                </div>
        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header bg-primary py-3 text-white">
                    ...
                    <h5 class="card-title mb-0 text-white">Total matrícula nivel SECUNDARIA por grado y sexo según UGEL al {{$fecha_Matricula_texto}}</h5>
                </div>
