<div class="col-md-6">
    <div>
        <h5  style="color: #427bf5;"> Total matrícula EBR según DISTRITO al {{$fecha_Matricula_texto}} </h5>
    </div>
...
<div class="col-md-12">
    <div>
        <br><br> <h5  style="color: #427bf5;"> Total matrícula nivel PRIMARIA por grado y sexo según Distrito al {{$fecha_Matricula_texto}} </h5>
    </div>
    ...
    <div class="table-responsive">
        <table style="width: 100%;  "  border="1px solid #000" >
            <thead>
                <tr>
                    <th colspan="1" rowspan="3" class="titulo_tabla">DISTRITO</th>
                    <th colspan="3" class="titulo_tabla">TOTAL</th>
...
<div class="col-md-12">
    <div>
        <br><br> <h5  style="color: #427bf5;"> Total matrícula nivel SECUNDARIA por grado y sexo según Distrito al {{$fecha_Matricula_texto}} </h5>
    </div>
