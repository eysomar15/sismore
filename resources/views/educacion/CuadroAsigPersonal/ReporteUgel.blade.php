    ...
    <div class="col-md-6">
        <div>
            <h5  style="color: #427bf5;"> Total Docentes según UGEL al FECHA </h5>
        </div>
        <div class="table-responsive">
            <table class="table table-bordered mb-0">
                ...
                @foreach ($lista_principal as $item)
                    ...
                    <tr>                                            
                        <td>{{$item->ugel}}</td>
                        <td class="columna_derecha">{{ number_format($item->cantidad,0) }} </td>
                    </tr>
                    ...
                    <tr> 
                        <td> <b> TOTAL </b></td>
                        <td class="columna_derecha_total"> {{number_format($suma,0)}} </td>
    ...
    <div class="col-md-6">
        <div>
            <br><br> <h5  style="color: #427bf5;"> Total Docentes por niveles según UGEL al FECHA </h5>
        </div>
