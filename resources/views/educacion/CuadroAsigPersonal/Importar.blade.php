            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="form">
                        ...
                        <form action="{{route('CuadroAsigPersonal.guardar')}}" method="post" enctype='multipart/form-data'
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input type="text" class="form-control" readonly="readonly" value="UNIDAD DE GESTION EDUCATIVA LOCALñ">
                                </div>
                            </div>
