    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card card-border card-primary">
                <div class="card-header bg-transparent pb-0">
                    @if ($indicador_id==24)
                    <h3 class="card-title">TOTAL CONEXIONES CON AGUA POR CATEGORIA</h3>
                    @else
                    <h3 class="card-title">TOTAL CONEXIONES CON DESAGUE POR CATEGORIA</h3>
                    @endif                    
                </div>
                <div class="card-body">
                    <div class="row">
        ...
        <div class="col-md-6">
            <div class="card card-border card-primary">
                <div class="card-header bg-transparent pb-0">
                    @if ($indicador_id==24)
                    <h3 class="card-title">TOTAL CONEXIONES SIN AGUA POR CATEGORIA</h3>
                    @else
                    <h3 class="card-title">TOTAL CONEXIONES SIN DESAGUE POR CATEGORIA</h3>
                    @endif                 
                </div>
                <div class="card-body">
                    <div class="row">
